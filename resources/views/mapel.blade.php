...
<div id="semua_alert">
  ...
  <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('mapel.index') }}">DETAIL info matapelajaran</a>
        <!-- Form -->
    ...
    <div class="header bg-gradient-primary pb-6 pt-5 pt-md-7" id="header">
      <h1 class="text-white text-center text-capitalize">Info Semua Matapelajaran</h1>
    </div>    
          ...
          <div class="modal fade" id="tambah_kelas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-content">
                  ...
                  <div class="form-group row">
                      <label for="mapel" class="col-3 col-form-label text-capitalize">Mata pelajaran</label>
                      <input type="text" name="mapel" id="mapel" class="col-9 form-control" placeholder="silahkan masukan kelas">
                  </div>
                  </div>
